...
const Hero = () => {
  return (
    <div className="w-full h-screen relative">
      ...
      {/* Content........ */}
      <div className="absolute  w-[ 627px] h-[140px] top-[370px] flex flex-col justify-center left-[15px]  md:left-[84px]  text-white ">
        ...
        <p className=" pb-8 font-[200] md:font-[400] text-[20px] md:text-[48px] leading-[40px]">
